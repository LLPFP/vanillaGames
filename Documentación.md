...
Crea una carpeta bden la raiz y crea dentro el archivo datosPrueba.js con el siguiente código:
...
Creamos una función enviarDatos(formulario) que recibe el formulario
...
Para que este código funcione actualizamos los inputs del formulario para que incorporen el atributo name.
...
Ahora solo falta registrar los datos del usuario en el localstorage.
...
Para asegurarnos que en menú de usuario se inyectan correctamente tanto el email como el rol añadimos lo siguiente en header.js
...
Desde el script de header.js detectamos cuando se hace clic en cerrar sesión.
...
### También debes recordar importar el objeto ls.
    ...
    Con todas las actualizaciones el header.jsquedaría así:
...
![alt text](https://carrebola.github.io/vanillaPill/assets/images/tabla-da2e0ee6dee1a3a7fdd1926b7b0b0721.png)
...
![alt text](https://carrebola.github.io/vanillaPill/assets/images/tarjetas-3419ecf80ed074b7ef2147a2031405e1.png)
...
![alt text](https://carrebola.github.io/vanillaPill/assets/images/filtro-36c29edf294cf81d1e32be5dd6503882.png)
...
El código para gestionar la visualización de las pestañas:
...
![alt text](https://carrebola.github.io/vanillaPill/assets/images/modalimagenperfil-17747305ae0d15008fd3a3c9c4d202c4.png)
...
Primero vamos a simular una consulta a la bd con el id del proyecto correspondiente.
...
Ahora vamos a modificar la fecha para poder introducirla en nuestro input de tipo date.
...
#### Volver atrás y editar cargando las vista que corresponda con window.location:
